...
Label(frame,text = "Private Key(That is poorly secured so that the hackers can hack):" ,fg='black',bg='white').grid(row=2,column=0,sticky=W, pady=10)
...
def openNewWindow():
   ...
   username = account1.get()
   password = private_key.get()
    
   if username == "mycryptoacccount" and password = 1234
